...
// this statment is selecting from the server where the username is the username entered and password is the password entered
$stmt = $myPDO->prepare("SELECT * FROM users WHERE username='$name' AND password='$pass'");
$stmt->execute();

    $row = $stmt->fetch();
// finding the username and passwords and if they are the same as your credenctials, it will take you to the main page where you can add/del/edit posts
